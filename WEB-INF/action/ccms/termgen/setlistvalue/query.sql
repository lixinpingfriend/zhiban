...
from
        ...
        inner join (select tl.tuid,tl.list_name,tl.list_code,tl.show_type as list_show_type,tti.item_code,tti.type_id,tti.list_show_type as item_show_type From t_term_list tl
