SELECT
    ...
    , case when t.parent_id is null and t.is_enabled = '1' and t.if_manual_push_flag='1' then concat('<a href="javascript:void(0);" onclick="javascript:showPool(',m.search_form_id,',',m.search_table_id,',',t.tuid,');" title="生成数据">传输到CS</a>')
    		else  ''
      end as show_pool
