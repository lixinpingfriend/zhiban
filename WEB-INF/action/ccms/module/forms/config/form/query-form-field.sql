...
from 
	...
	inner join (select a.field_id,a.is_mandatory,a.is_readonly,a.show_order,a.show_type,a.item_id,a.show_color,a.width,a.colspan,a.rowspan,a.is_cascade_combo from t_form_show_field a where a.form_id = ${fld:form_id}) s 	on t.tuid=s.field_id
